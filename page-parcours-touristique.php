...
$hero_img = thiam_page_asset_url($asset_base, 'Photo parcours touristique.webp');
$img_front = thiam_page_asset_url($asset_base, 'Merco avant.webp');
$img_luggage = thiam_page_asset_url($asset_base, 'paris de jour.webp');
$img_business = thiam_page_asset_url($asset_base, 'femme trajet touristique.webp');
  ...
  <?php if ( ! $show_reservation ) : ?>
    <div class="aero-landing aero-landing--depose">
      <section class="aero-hero" style="--aero-hero: url('<?php echo esc_url($hero_img); ?>');">
        <div class="aero-hero__label">Trajet touristique</div>
      </section>
      ...
      <section class="aero-feature-row" aria-label="Points forts">
        <article class="aero-feature-item">
          ...
          <h3 class="aero-feature-item__title aero-feature-item__title--reservation">Organisation</h3>
          <p class="aero-feature-item__text aero-feature-item__text--pickup">Choisissez votre qui vous fait envie et decouvrez la ville d'une nouvelle maniere</p>
        </article>
        <article class="aero-feature-item">
          <span class="aero-feature-item__icon" aria-hidden="true">
          ...
          <h3 class="aero-feature-item__title aero-feature-item__title--pickup">Accompagnement</h3>
          <p class="aero-feature-item__text aero-feature-item__text--timing">Profitez pleinement de votre visite, le trajet s'adapte à votre rythme.</p>
        </article>
        <article class="aero-feature-item">
          <span class="aero-feature-item__icon" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" width="74" height="77" viewBox="0 0 74 77" fill="none">
          ...
          <h3 class="aero-feature-item__title aero-feature-item__title--serenites">Découverte</h3>
          <p class="aero-feature-item__text aero-feature-item__text--serenites">Prenez le temps de découvrir les lieux uniques de manière plus intime.</p>
        </article>
      </section>
      ...
      <div class="aero-story-stack">
        <section class="aero-story" id="coffre">
          <article class="aero-text-block">
            <h2>UNE AUTRE FAÇON DE DÉCOUVRIR</h2>
            <p>
              Découvrir la ville autrement, c'est prendre le temps d'en admirer les lieux les plus emblématiques dans le confort et la tranquillité d'un VTC. Nos trajets touristiques vous permettent de voyager d'un point A à un point B, tout en traversant les sites incontournables qui font la renommée de la capitale. Au fil du trajet, vous pourrez découvrir les destinations les plus prisées par les visiteurs, telles que les Champs-Élysées, la Tour Eiffel, la place de la Concorde, le Louvre, Notre-Dame ou encore Montmartre. Grâce à un service flexible et personnalisé, vous profitez pleinement de votre visite à votre rythme, sans stress lié aux transports.
            </p>
          </article>
          <figure class="aero-story__media">
            <img src="<?php echo esc_url($img_luggage); ?>" alt="">
          </figure>
        </section>

        <section class="aero-story aero-story--reverse" id="sieges">
          <figure class="aero-story__media">
            <img src="<?php echo esc_url($img_business); ?>" alt="">
          </figure>
          <article class="aero-text-block">
            <h2>PROFITEZ DE CHAQUE INSTANT</h2>
            <p>
              Laissez-vous porter et concentrez-vous sur la découverte, nous nous occupons du reste. Notre mission est de vous libérer de toute charge mentale liée à l'organisation de vos transports. De la planification de l'itinéraire à la gestion du temps, chaque aspect de votre voyage est pris en main par notre équipe avec une rigueur absolue. Profitez pleinement de la beauté des paysages ou de vos moments de détente sans vous soucier de la route. Avec nous, voyager devient un plaisir pur, fluide et sans imprévu. Votre sérénité est le cœur même de notre engagement.
            </p>
          </article>
        </section>
      </div>
